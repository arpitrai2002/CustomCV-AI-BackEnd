...
export interface ApiUserResumeeUserResumee extends Struct.CollectionTypeSchema {
  collectionName: 'user_resumees';
  info: {
    description: '';
    displayName: 'User Resumee';
    pluralName: 'user-resumees';
    singularName: 'user-resumee';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-resumee.user-resumee': ApiUserResumeeUserResumee;
